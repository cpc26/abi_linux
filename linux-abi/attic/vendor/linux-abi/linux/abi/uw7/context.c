...
int uw7_sigaltstack(const uw7_stack_t *uw7_ss, uw7_stack_t *uw7_oss)
{
...
static int getcontext(uw7_context_t * uc, struct pt_regs * regs)
{
	uw7_context_t tmp = { 0 };
...
static int getxcontext(uw7_context_t * uc, struct pt_regs * regs)
{
	return 0;
}

static int setcontext(uw7_context_t * uc, struct pt_regs * regs)
{
...
int uw7_context(struct pt_regs * regs)
{
