...
#include "../include/uw7/types.h"
#include "../include/uw7/stat.h"
...
report_uw7_stat64(struct kstat *stp, struct uw7_stat64 *bufp)
{
	...
	buf.st_atime.tv_sec = stp->atime.tv_sec; y2k_send(buf.st_atime.tv_sec); 
	buf.st_mtime.tv_sec = stp->mtime.tv_sec; y2k_send(buf.st_mtime.tv_sec); 
	buf.st_ctime.tv_sec = stp->ctime.tv_sec; y2k_send(buf.st_ctime.tv_sec); 
